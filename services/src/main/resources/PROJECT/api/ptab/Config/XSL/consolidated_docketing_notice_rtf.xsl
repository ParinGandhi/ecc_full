...
<fo:block-container height="15cm" width="19cm" top="3cm" left="0cm" position="absolute"
	...
	<xsl:when test="substring(//applicationNumber,1,2)='95'">
	<fo:block space-before.optimum="10pt">		
 ...
 <fo:block-container height="15cm" width="19cm" top="13cm" left="0cm" position="absolute"
	...
	<fo:block text-indent="2cm" line-height="18pt" space-before.optimum="5pt" space-after.optimum="5pt">	    
        <xsl:call-template name="SPACE_TEMPLATE" /><xsl:call-template name="SPACE_TEMPLATE" />
	...
	<fo:block text-indent="1cm" line-height="18pt" space-before.optimum="5pt" space-after.optimum="5pt">	    
		<xsl:call-template name="SPACE_TEMPLATE" /><xsl:call-template name="SPACE_TEMPLATE" />
...
<fo:block-container height="15cm" width="19cm" top="10cm" left="0cm" position="absolute"
 ...
 <fo:block-container height="16cm" width="19cm" top="23cm" left="0cm" position="absolute">
...
<!--2nd page-->
  ...
  <fo:block-container height="15cm" width="19cm" top="4cm" left="0cm" position="absolute"
   ...
   <fo:block text-indent="1cm" line-height="18pt" space-before.optimum="5pt">
     <xsl:call-template name="SPACE_TEMPLATE" /><xsl:call-template name="SPACE_TEMPLATE" />   
 ...
 <fo:block-container height="15cm" width="19cm" top="5.75cm" left="0cm" position="absolute"
        font-family="Times Roman" font-size="12pt" text-align="justify">
   <fo:block text-indent="1cm" line-height="18pt" space-before.optimum="5pt">
     <xsl:call-template name="SPACE_TEMPLATE" /><xsl:call-template name="SPACE_TEMPLATE" />   
...
<fo:block-container height="15cm" width="19cm" top="8cm" left="0cm" position="absolute"
        font-family="Times Roman" font-size="12pt" text-align="left">
	<fo:block line-height="18pt" space-before.optimum="5pt" space-after.optimum="5pt">	    
       cc: Third Party Requester 
    </fo:block>		
 </fo:block-container>	
 <fo:block-container height="5cm" width="12cm" top="9cm" left="1.0cm" position="absolute">
	<xsl:call-template name="ADDRESS_head"/>
</fo:block-container>

 <fo:block-container height="5cm" width="12cm" top="11cm" left="1.0cm" position="absolute">
