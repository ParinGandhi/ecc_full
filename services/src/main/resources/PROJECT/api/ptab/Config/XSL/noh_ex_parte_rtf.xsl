...
<xsl:template name="SPACE_TEMPLATE_MINI">
    <xsl:text>&#xA0;&#xA0;&#xA0;&#xA0;</xsl:text>  
</xsl:template>
<xsl:template name="SPACE_TEMPLATE_MINI2">
    <xsl:text>&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;</xsl:text>  
</xsl:template>
...
<xsl:template name="QUESTIONS_TEXT">
	...
	<fo:block font-size="12pt" text-align = "justify">
       For further information about hearings, see 37 CFR § 41.73 and the Hearings section of the PTAB webpage:
    </fo:block>
	<fo:block font-size="12pt" >
       <fo:inline text-decoration="underline" color = "blue">http://www.uspto.gov/patents-application-process/patent-trial-and-appeal-board/hearings</fo:inline>. Also, for questions, please contact the PTAB Hearings Clerk at 571-272-9797.
    </fo:block>	
</xsl:template>

<xsl:template name="PAGE_header">
 <fo:block-container height="2cm" width="25cm" top="0.5cm"  position="absolute" margin-top="0.5cm" margin-left="1cm" margin-right="0.5cm"
	...
	<fo:table table-layout="fixed" >
		...
		<fo:table-body>
			<fo:table-row>
				...
				<fo:table-cell>
					<fo:block  font-family="Times Roman" font-size="12pt" text-align="end" space-after.optimum="10pt">
					Page <fo:page-number/> 
					</fo:block>
				</fo:table-cell>
			</fo:table-row>	
	...
	<fo:table table-layout="fixed" >
		...
		<fo:table-body>
			<fo:table-row>
				...
				<fo:table-cell>
					<fo:block  font-family="Times Roman" font-size="12pt" text-align="end" >
					Page 2
					</fo:block>
				</fo:table-cell>
			</fo:table-row>	
...
<xsl:template name="CONFIRMATION_WAIVER_METHODS">
	<fo:block text-indent="1cm" line-height="18pt" space-before.optimum="1pt">
      <xsl:call-template name="SPACE_TEMPLATE_MINI" />
 ...
 <fo:list-block provisional-distance-between-starts="0.2cm" provisional-label-separation="0.5cm"
  ...
  <fo:list-item space-after="2mm">
    <fo:list-item-label end-indent="label-end()">
      <fo:block>(<xsl:call-template name="TAB_SPACE" />)</fo:block>
    </fo:list-item-label>
...
<xsl:template name="OWNER_CHECK"> 
   <fo:block font-size="12pt" text-align = "justify">
	(<xsl:call-template name="TAB_SPACE" />) PATENT OWNER
	<xsl:call-template name="SPACE_TEMPLATE" />
	<xsl:call-template name="SPACE_TEMPLATE" />
	(<xsl:call-template name="TAB_SPACE" />) THIRD PARTY REQUESTER
	</fo:block >
</xsl:template>
...
<xsl:template name="Submission_Notice_of_Hearing">
<fo:block  text-indent="1cm" line-height="18pt" space-before.optimum="1pt">
	...
	<fo:block font-size="12pt" text-align = "justify" text-indent="4.5cm" >	
	<xsl:call-template name="SPACE_TEMPLATE_MINI" />
	<xsl:call-template name="SPACE_TEMPLATE_MINI" />
	<xsl:call-template name="SPACE_TEMPLATE_MINI" />
	<xsl:call-template name="SPACE_TEMPLATE_MINI" />
	...
	<xsl:call-template name="SPACE_TEMPLATE_MINI2" />
	<xsl:call-template name="SPACE_TEMPLATE_MINI2" />
		Patent Trial and Appeal Board
	</fo:block>	
	<fo:block font-size="12pt" text-align = "justify" text-indent="5.5cm" >	
...
<xsl:template name="Hearing_Attendance_Options">
	<xsl:call-template name="SPACE_TEMPLATE1" />
<fo:block >	
	...
	<fo:block font-size="12pt" text-align = "justify">	
		(<xsl:call-template name="TAB_SPACE" />)  I elect an IN-PERSON hearing and request to appear at a hearing room in the following USPTO office:  
	</fo:block>	
	...
	<xsl:call-template name="SPACE_TEMPLATE_MINI2" />
		(<xsl:call-template name="TAB_SPACE" />)  ALEXANDRIA, VA - 600 Dulany Street  
	</fo:block>		
	<fo:block  font-size="12pt" text-align = "justify" text-indent="2.5cm">	
	<xsl:call-template name="SPACE_TEMPLATE_MINI2" />
		(<xsl:call-template name="TAB_SPACE" />)  DALLAS, TX - 207 South Houston Street  
	</fo:block>		
	<fo:block  font-size="12pt" text-align = "justify" text-indent="2.5cm">	
	<xsl:call-template name="SPACE_TEMPLATE_MINI2" />
		(<xsl:call-template name="TAB_SPACE" />)  SAN JOSE, CA - 26 S. Fourth Street   
	</fo:block>		
	<fo:block  font-size="12pt" text-align = "justify" text-indent="2.5cm">
	<xsl:call-template name="SPACE_TEMPLATE_MINI2" />	
		(<xsl:call-template name="TAB_SPACE" />)  DETROIT, MI - 300 River Place Drive  
	</fo:block>		
	<fo:block  font-size="12pt" text-align = "justify" text-indent="2.5cm">	
	<xsl:call-template name="SPACE_TEMPLATE_MINI2" />
		(<xsl:call-template name="TAB_SPACE" />)  DENVER, CO - 1961 Stout Street  
	</fo:block>	
	
	<xsl:call-template name="SPACE_TEMPLATE1" />
	
	<fo:block font-size="12pt" text-align = "justify" >	
		(<xsl:call-template name="TAB_SPACE" />)  I elect a TELEPHONIC hearing. 
	</fo:block>	
	
	<xsl:call-template name="SPACE_TEMPLATE1" />
	
	<fo:block font-size="12pt" text-align = "justify" >	
		(<xsl:call-template name="TAB_SPACE" />)  I elect a VIDEO hearing and will appear from a non-USPTO location that I secure for myself.  
	</fo:block>	
	
	<xsl:call-template name="SPACE_TEMPLATE1" />
	
	<fo:block font-size="12pt" text-align = "justify" >	
		(<xsl:call-template name="TAB_SPACE" />)   I WAIVE the hearing.
	</fo:block>	
	
	<xsl:call-template name="SPACE_TEMPLATE1" />
		
	<fo:block font-size="12pt" text-align = "justify"> 
		(<xsl:call-template name="TAB_SPACE" />) I am requesting to RESCHEDULE the hearing. <fo:inline font-weight="bold">A separate paper must be filed.</fo:inline>
	</fo:block>
</xsl:template>
...
<fo:block font-size="12pt" text-align = "justify">
	...
	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block>____________________________________________________________
    </fo:block>
	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block>____________________________________________________________
    </fo:block>
...
<fo:block-container height="5cm" width="12cm" top="3cm" left="0cm" position="absolute" margin-left="0.3cm" >
	<xsl:call-template name="uspto_letter_head18" />
</fo:block-container>			
  <xsl:call-template name="SPACE_TEMPLATE1" />
  <!-- ********************* ADDRESS and APPEAL *****************-->
<fo:block-container height="5cm" width="18cm" top="7cm" left="0cm" position="absolute">
	<fo:table table-layout="fixed" space-before.optimum="5pt" margin-left="0.5cm"  >
...
<fo:block-container height="15cm" width="19cm" top="11.5cm" left="0cm" position="absolute" margin-left="1cm" margin-right="1cm"
...
<xsl:call-template name="SPACE_TEMPLATE1" />
 <!--1st page-->
<fo:block-container  top="13cm"   position="absolute" margin-left="1cm"  margin-bottom="1cm" margin-right="0.5cm"
        font-family="Times Roman" font-size="12pt" >
	<fo:block>	
  <xsl:if test="(substring(//applicationNumber,1,2)='95')">
	<fo:block font-size="12pt" text-align = "justify">
     The Patent Trial and Appeal Board (PTAB) will hear the above-identified appeal on the date indicated.  The hearing will commence at the time set, and as soon as the argument in one appeal concludes, the succeeding appeal will be taken up.
		<fo:inline font-weight="bold">The time allowed for argument is 30 minutes for each Appellant or Respondent who has requested a hearing, </fo:inline>unless additional time is requested and approved before the argument commences. <fo:inline font-weight="bold">Because the hearing relates to an appeal of a reexamination, the hearing will be open to the public.</fo:inline>
    </fo:block>
	<xsl:call-template name="SPACE_TEMPLATE" />
	<fo:block font-size="12pt" text-align = "justify">
...
<fo:block break-before="page"></fo:block>
 ...
 <xsl:if test="(substring(//applicationNumber,1,2)='95')">
 <fo:block-container height="15cm" width="19cm" top="1cm" left="0cm" position="absolute" margin-left="1cm" margin-right="0.5cm" margin-bottom="1cm"
...
<fo:block-container height="15cm" width="19cm" top="1cm" left="0cm" position="absolute" margin-left="1cm" margin-right="0.5cm" margin-bottom="1cm"
	...
	<fo:block font-size="12pt" >
       If Appellant and/or Respondent has any Power Point slides or other demonstratives, they must be provided to the PTAB five (5) days before the hearing date by sending them to PTABHearings@uspto.gov.
		...
		<xsl:call-template name="SPACE_TEMPLATE1" />
	<xsl:call-template name="Submission_Notice_of_Hearing"/>
	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block font-size="12pt" text-align = "justify">
     <fo:inline text-decoration="underline" font-weight="bold" font-style="italic">Questions</fo:inline>
    </fo:block>	  
...
<fo:block-container height="15cm" width="19cm" top="12cm" left="0cm" position="absolute" margin-left="1cm" margin-right="0.5cm"
					font-family="Times Roman" font-size="12pt" font-weight="bold" text-align="center">
	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block space-before.optimum="10pt">
...
<fo:block-container height="15cm" width="19cm" top="1cm" left="0cm" position="absolute" margin-left="1cm" margin-right="0.5cm" margin-bottom="1cm"
  ...
  <xsl:call-template name="SPACE_TEMPLATE1" />
	...
	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block font-size="12pt" text-align = "justify">
       (<xsl:call-template name="TAB_SPACE"/>) I previously filed my oral hearing request pursuant to 37 C.F.R. § 41.73(b).
    </fo:block>
	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block font-size="12pt" text-align = "justify">
       (<xsl:call-template name="TAB_SPACE" />) I am now filing my initial request to participate in the oral hearing pursuant to 37 C.F.R. § 41.73(d). A request for oral hearing and the fee set forth in 37 C.F.R. § 41.20(b)(3) are either 
    </fo:block>
	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block font-size="12pt" text-align = "justify">
       (<xsl:call-template name="TAB_SPACE" />) attached to this hearing communication or 
    </fo:block>
	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block font-size="12pt" text-align = "justify">
       (<xsl:call-template name="TAB_SPACE" />) have already been submitted.
    </fo:block>
	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block >	
		<fo:inline text-decoration="underline" font-weight="bold" font-style="italic">Hearing Attendance Options (please select one)</fo:inline>
...
<fo:block-container height="15cm" width="19cm" top="1cm" left="0cm" position="absolute" margin-left="1cm" margin-right="0.5cm" margin-bottom="1cm"
	...
	<fo:block font-size="12pt" text-align = "justify">
       (4) San Jose, California. The PTAB attempts to grant all hearing location requests, subject to space availability. Usage of a hearing room or a conference room in one of the regional offices is not guaranteed until confirmed by the PTAB. In the event the request cannot be granted, then Appellant is responsible for proposing an alternate option, such as selecting a different USPTO location, by telephone, or by video, which is subject to approval by the PTAB. <fo:inline text-decoration="underline" font-weight="bold">Appellant’s selection and the PTAB’s approval to utilize a hearing room or a conference room does not guarantee that an Administrative Patent Judge assigned to the appeal will be physically present at that location</fo:inline>.
...
<fo:block-container height="15cm" width="19cm" top="1cm" left="0cm" position="absolute" margin-left="1cm" margin-right="0.5cm" margin-bottom="1cm"
	...
	<xsl:call-template name="Submission_Notice_of_Hearing" />
		<xsl:call-template name="SPACE_TEMPLATE1" />
	<xsl:call-template name="QUESTIONS_TEXT" />
...
<fo:block-container height="15cm" width="19cm" top="1cm" left="0cm" position="absolute" margin-left="1cm" margin-right="0.5cm" margin-bottom="1cm"
	...
	<xsl:call-template name="Hearing_Attendance_Options"/>
...
<fo:block-container height="15cm" width="19cm" top="1cm"  position="absolute" margin-left="1cm" margin-right="0.5cm" margin-bottom="1cm"
        font-family="Times Roman" font-size="12pt" text-align="start"> 
  	<xsl:call-template name="SPACE_TEMPLATE1" />
	<fo:block font-size="12pt" text-align = "justify">
       Appellant responds to the NOTICE OF HEARING in the above-identified appeal. 
