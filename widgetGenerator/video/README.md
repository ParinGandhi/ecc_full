...
video widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
```javascript
angular.module('sample', ['adf', 'adf.widget.video']);
```
