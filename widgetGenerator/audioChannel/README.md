...
audioChannel widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-audioChannel
...
```html
<script type="text/javascript" src="path/to/audioChannel.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.audioChannel']);
```
