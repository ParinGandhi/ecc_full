...
angular.module('adf.widget.web', ['adf.provider'])
  .config(function (dashboardProvider) {
    ...
    if (angular.isDefined($scope.$parent.model)) {
      ...
      var htmlToInsert = '<iframe width="100%" src="' + $scope.$parent.model.dataUrlText + '" frameborder="0" style="height:' + custHeight + '"></iframe>';
