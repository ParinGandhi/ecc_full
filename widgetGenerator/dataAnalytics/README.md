...
dataAnalytics widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-dataAnalytics
...
```html
<script type="text/javascript" src="path/to/dataAnalytics.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.dataAnalytics']);
```
